						...
						<div class="row">
							<div class="col col-m-12 col-t-5 col-d-5">
								<div class="st-box mobile">
									<div class="st-title">George Outa</div>
									<div class="st-subtitle">Full Stack Developer</div>
									<div class="st-soc">
										<a target="blank" href="https://github.com.com/" class="btn_animated">
										...
										<a target="blank" href="https://www.linkedin.com/in/george-outa/" class="btn_animated">
								...
								<div class="profile-image">
									<img src="images/man_big.jpg" alt="" />
								</div>
								<div class="info-list">
									<ul>
										<li><strong><span>Address:</span></strong> Nairobi, Kenya</li>
										<li><strong><span>Phone:</span></strong> <a href="tel:+254700613065">+254 700 613065</a></li>
										<li><strong><span>E-mail:</span></strong> <a href="mailto:george.jarviz@gmail.com">george.jarviz@gmail.com</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="content-box animated">
								...
								<div class="skills">
									<ul>
										...
										<li> 
											<div class="name">CCNA Certification</div>
											<div class="progress">
												<div class="percentage" style="width:20%;">
													<span class="percent"><i class="icon ion ion-ios-checkmark-empty"></i></span>
												</div>
											</div>
										</li>
										<li> 
											<div class="name">CCDA Certification</div>
											<div class="progress">
